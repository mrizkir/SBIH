      ...
      <View style={styles.content}>
        ...
        <View style={styles.headerSection}>
          ...
          <View style={styles.titleContainer}>
            <Text style={[styles.mainTitle, styles.titleTextCenter]}>Badan Perencanaan Pembangunan Riset dan Inovasi Daerah Kabupaten Bintan</Text>            
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.contactItem}>
            ...
            <View style={styles.contactTextContainer}>
              ...
              <Text style={styles.contactText}>bapelitbang@bintankab.go.id</Text>
            </View>
          </View>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerSubtext}>Versi {APP_VERSION} @2026 BAPPERIDA Kabupaten Bintan</Text>
        </View>
      </View>
    </ScrollView>
  )
