...
const GrafikHLS = (props) => {
  ...
  if (!Array.isArray(dataAngkaHarapanLamaSekolah) || dataAngkaHarapanLamaSekolah.length === 0) {
    return (
  ...
  const sortedAllData = [...(Array.isArray(dataAngkaHarapanLamaSekolah) ? dataAngkaHarapanLamaSekolah : [])].sort((a, b) => a.tahun - b.tahun);
